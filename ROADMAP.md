...
## Done
- [x] Add `pnpm context --compare` flag to diff the char-count breakdown between two cycles (e.g. `--compare 10 20`), making it easy to see which context sections grew or shrank between runs and detect prompt-bloat regressions.
  Completed in cycle 818: 3/3 improvements succeeded.
